# baseline-migration Specification

## Purpose
Defines migration from 1.0 baseline format to 1.1 compressed format, including automatic migration on load and manual CLI migration command.
