# baseline-compression Specification

## Purpose
Defines compression algorithms for CodeGraph baselines, reducing file size through ID deduplication, path table interning, JSDoc truncation, and edge batching.
