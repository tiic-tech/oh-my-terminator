# layer-naming Specification

## Purpose

Provides layer role name inference from directory patterns, mapping group names to semantic layer names using configurable naming rules with confidence tracking.
